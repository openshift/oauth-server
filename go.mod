...
replace (
	...
	github.com/openshift/library-go => github.com/ardaguclu/library-go v0.0.0-20220825112306-ffafdb107050
	k8s.io/apiserver => github.com/openshift/kubernetes-apiserver v0.0.0-20220602113045-0ae2a4712dab // points to openshift-apiserver-4.9-kubernetes-1.22.2
)
