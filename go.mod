...
replace k8s.io/apiserver => github.com/ingvagabund/kubernetes-apiserver v0.0.0-20260306164045-e9bd1f437897 // points to openshift-apiserver-4.22-kubernetes-1.35.2
