...
replace k8s.io/apiserver => github.com/ingvagabund/kubernetes-apiserver v0.0.0-20260331194754-69a4ff5de266 // points to openshift-apiserver-4.22-kubernetes-1.35.2
