...
replace k8s.io/apiserver => github.com/openshift/kubernetes-apiserver v0.0.0-20250526074939-69bc847b1ee3 // points to openshift-apiserver-4.19-kubernetes-1.32.1
