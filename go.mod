...
replace k8s.io/apiserver => github.com/openshift/kubernetes-apiserver v0.0.0-20230601103939-2f4fff6f35b7 // points to openshift-apiserver-4.14-kubernetes-1.27.1
