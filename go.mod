...
replace k8s.io/apiserver => github.com/openshift/kubernetes-apiserver v0.0.0-20240312083446-be9e4a60dde6 // points to openshift-apiserver-4.15-kubernetes-1.28.3
