...
func TestWithOAuth_loginProviders(t *testing.T) {
	...
	for _, tt := range []struct {
		...
		{
			name: "multiple login providers with spaces in name and replaced in client",
			providers: []osinv1.IdentityProvider{
				newProvider("idp-no-spaces"),
				newProvider("idp with spaces"),
			},
		...
		},
		{
			...
			providers: []osinv1.IdentityProvider{
				newProvider("idp-no-spaces"),
				newProvider("idp%20escaped"),
			},
		},
		{
			name: "multiple login providers with %20 in name and replaced in client",
			providers: []osinv1.IdentityProvider{
				newProvider("idp-no-spaces"),
				newProvider("idp%20escaped"),
			},
		...
		{
			name: "multiple login providers with %20 in name and escaped in client",
			providers: []osinv1.IdentityProvider{
				newProvider("idp-no-spaces"),
				newProvider("idp%20escaped"),
			},
